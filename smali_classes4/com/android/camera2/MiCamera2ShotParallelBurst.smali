...
.method private applyClearShotParameter(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    sget-boolean p0, Lcom/mi/config/b;->J:Z
...
.method private applyHdrParameter(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    const-string v1, "[ALGOUP|MMCAMERA] Algo Up HDR!!!!"
    ...
    sget-boolean v1, Lcom/mi/config/b;->N:Z

    if-nez v1, :cond_4

    sget-boolean v1, Lcom/mi/config/b;->P:Z

    if-nez v1, :cond_4

    sget-boolean v1, Lcom/mi/config/b;->U:Z

    if-nez v1, :cond_4

    sget-boolean v1, Lcom/mi/config/b;->Q:Z
    ...
    invoke-virtual {v1}, Lcom/mi/config/a;->F2()Z
    ...
    .line 27
    :cond_a
    iget-boolean v1, p0, Lcom/android/camera2/MiCamera2ShotParallelBurst;->mSingleCaptureForHDRplusMFNR:Z
    ...
    const-string v1, "applyHdrParameter disable mfnr EV = "
...
.method private prepareSR()V
    ...
    invoke-virtual {v0}, Lcom/mi/config/a;->z()I
...
.method protected generateRequestBuilder()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    sget-boolean v2, Lcom/mi/config/b;->J:Z
...
.method protected prepare()V
    ...
    .line 6
    sget-boolean v2, Lcom/mi/config/b;->Q:Z
    ...
    invoke-virtual {v2}, Lcom/mi/config/a;->o3()Z
...
.method protected startSessionCapture()V
    ...
    invoke-virtual {v7}, Lcom/mi/config/a;->S2()Z
    ...
    .line 18
    :cond_3
    sget-boolean v3, Lcom/mi/config/b;->P:Z
